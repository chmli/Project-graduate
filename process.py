...
def parse_args():
    ...
    parser.add_argument('--json_root', default='./dataset/CUHK-PEDES/reid_raw.json', type=str)
    parser.add_argument('--out_root', default='./dataset/CUHK-PEDES/processed_data', type=str)
